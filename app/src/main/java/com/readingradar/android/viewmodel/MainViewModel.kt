...
import com.readingradar.android.data.database.BestSellersDb
import com.readingradar.android.data.database.dao.BestSellersDao
import com.readingradar.android.data.models.Lists
import com.readingradar.android.data.network.BestSellersApiService
...
class MainViewModel : ViewModel() {
    ...
    private fun getAllBestSellers() {
        viewModelScope.launch {
            bestSellersDao = BestSellersDb.getDaoInstance(com.readingradar.android.BestSellersApplication.getAppContext())
